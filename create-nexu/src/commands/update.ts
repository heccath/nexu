...
async function updatePackages(projectDir: string, templateDir: string): Promise<void> {
...
async function updateConfig(projectDir: string, templateDir: string): Promise<void> {
  ...
  // Update husky
  const huskySrc = path.join(templateDir, '.husky');
  ...
  const vscodeSrc = path.join(templateDir, '.vscode');
...
async function updateWorkflows(projectDir: string, templateDir: string): Promise<void> {
  const spinner = ora('Updating GitHub workflows...').start();

  // Update workflows
  const workflowsSrc = path.join(templateDir, '.github', 'workflows');
  ...
  // Update actions
  const actionsSrc = path.join(templateDir, '.github', 'actions');
  ...
  // Update dependabot
  const dependabotSrc = path.join(templateDir, '.github', 'dependabot.yml');
...
async function updateServices(projectDir: string, templateDir: string): Promise<void> {
  const spinner = ora('Updating Docker services...').start();

  const servicesSrc = path.join(templateDir, 'services');
